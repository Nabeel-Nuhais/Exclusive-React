    ...
    <>
      <MainContainer>
        <CardWrapper>
          <ProductContainer>
            <ProductContent>
              <TopContainer>
                <ProductImageWrapper>
                  <ProductImage
                    src={require("../../../../assets/images/dog-food.png")}
                    alt="product-image"
                  />
                </ProductImageWrapper>
                <TopRightContainer>
              ...
              <ProductDetails>
                <ProductName>Breed Dry Dog Food</ProductName>
          ...
          <ButtonContainer>
            <AddToCartButton>View All Products</AddToCartButton>
          </ButtonContainer>
        </CardWrapper>
      </MainContainer>
    </>
